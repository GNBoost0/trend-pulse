  ...
  return (
    <footer className="mt-20 border-t border-[var(--border)]" style={{background:'var(--bg-secondary)'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        {/* Desktop: logo à gauche, menus à droite */}
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          {/* Logo + nom */}
          <div className="flex flex-col items-center md:items-start shrink-0">
            <img src="/logo.png" alt="DailyTrend" className="w-full max-w-[200px] md:max-w-[180px]" />
          ...
          <div className="flex flex-col sm:flex-row gap-6 md:gap-10 flex-1 justify-center">
            <div>
        ...
        {/* Newsletter — en dessous, pleine largeur */}
